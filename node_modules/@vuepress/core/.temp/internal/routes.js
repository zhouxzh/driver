...
import GlobalLayout from "E:\\github\\driver\\node_modules\\@vuepress\\core\\lib\\client\\components\\GlobalLayout.vue"
...
export const routes = [
  {
    ...
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-1589de66").then(next)
    },
  },
  {
    path: "/index.html",
  ...
  {
    name: "v-3b79ee73",
    path: "/backend-note/chapter01.html",
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-3b79ee73").then(next)
    },
  },
  {
    name: "v-7541f21e",
    path: "/backend-note/chapter02.html",
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-7541f21e").then(next)
    },
  },
  {
    name: "v-b1564aac",
